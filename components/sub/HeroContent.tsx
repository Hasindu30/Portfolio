  ...
  return (
    ...
    >
      <div className='h-full w-full flex flex-col gap-5 justify-center m-auto text-start'>
        ...
        >
          I&apos;m Hasindu. I&apos;m a Software Engineer with quick learner with a strong ability to adapt to new challenges
          and Software development. Check out my projects and skills.
        </motion.p>

        {/* Updated button with download functionality */}
        <motion.a
          variants={slideInFromLeft(1)}
          href="/Hasindu_Resume.pdf"  // Path to the resume file in the public folder
          download="Hasindu_Resume.pdf"  // File name when downloaded
